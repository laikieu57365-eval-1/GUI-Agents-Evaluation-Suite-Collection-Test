...
The following are the Grounding/Perception benchmarks from the ScreenSuite evaluation suite:
...
Original evaluation suite: [huggingface/screensuite](https://github.com/huggingface/screensuite)