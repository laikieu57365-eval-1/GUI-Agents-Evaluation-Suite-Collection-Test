...
The following are the desktop environment-related Grounding benchmarks from the official HuggingFace ScreenSuite evaluation suite:
...
Official ScreenSuite Repository: https://github.com/huggingface/screensuite