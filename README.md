...
This repository collects information about the HuggingFace GUI Agents Evaluation Suite (ScreenSuite).

## Desktop Environment-related Grounding Benchmarks

The following are the desktop environment-related (Web platform) Grounding benchmarks from the ScreenSuite evaluation suite:
...
These benchmarks are from the official HuggingFace ScreenSuite repository: https://github.com/huggingface/screensuite